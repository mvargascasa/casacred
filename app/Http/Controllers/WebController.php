...
class WebController extends Controller
{
    ...
    public function sendlead(Request $request){
        ...
        mail('mvargas@casacredito.com,info@casacredito.com,ventas@casacredito.com,asesor1@casacredito.com,asesor2@casacredito.com','Lead CasaCredito: '.strip_tags($request->fname), $message, $header);
    ...
    public function sendLeadAval(Request $request){
        ...
        mail('info@casacredito.com,hserrano@casacredito.com,ventas@casacredito.com,asesor1@casacredito.com,asesor2@casacredito.com','Lead CasaCredito: '.strip_tags($request->fname), $message, $header);
    }
