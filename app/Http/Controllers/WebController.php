...
class WebController extends Controller
{
    ...
    public function index(Request $request, ?string $code = null, ?string $slug = null, ?string $ubication = null, ?string $category = null, ?string $type = null, ?string $state = null, ?string $city = null){
        ...
        if(!is_numeric($code)) {
            ...
            if($ubication){
                ...
                //dd($listings);
                return view('indexweb',compact('states', 'keywords', 'listings', 'types', 'categories'));
            }
        } else {
        ...
        else          return view('indexweb',compact('states', 'keywords', 'listings', 'types', 'categories'));
    ...
    public function home(){
        ...
        // else 
        return view('home', compact('ismobile'));
    }
    ...
    public function sendlead(Request $request){
        ...
        mail('mvargas@casacredito.com,info@casacredito.com,ventas@casacredito.com,ventas1@casacredito.com,ventas2@casacredito.com','Lead CasaCredito: '.strip_tags($request->fname), $message, $header);
    ...
    public function sendLeadAval(Request $request){
        ...
        mail('info@casacredito.com,hserrano@casacredito.com,ventas@casacredito.com','Lead CasaCredito: '.strip_tags($request->fname), $message, $header);
    }
