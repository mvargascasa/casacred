{{-- resources/views/components/contact-section-flexible.blade.php --}}
<section class="contact-section theme-{{ $theme }}"> 
    <div class="contact-container" style="background-color: {{ $backgroundColor }}"> 
        ...
        <div class="contact-form-wrapper"> 
            ...
            <form class="contact-form js-recaptcha" action="{{ route('send.lead.contact.section') }}" method="POST" id="contactForm"> 
                ...
                <div class="form-row"> 
                    ...
                    <div class="form-group"> 
                        <input type="text" name="apellido" id="apellido" placeholder="Apellido" required class="form-input"> 
                    </div> 
                </div> 
                <!-- Phone and Email Row --> 
                <div class="form-row"> 
                    ...
                    <div class="form-group"> 
                        <input type="email" name="email" id="email" placeholder="E-mail" required class="form-input"> 
                    </div> 
                </div> 
                <!-- Subject Field (Full Width) --> 
                <div class="form-group full-width"> 
                    <input type="text" name="asunto" id="asunto" placeholder="Asunto" class="form-input"> 
                </div> 
                <!-- Message Field --> 
                ...
                <div class="form-group checkbox-group"> 
                    <label class="checkbox-container"> 
                        ...
                        <span class="checkbox-text"> 
                            {{ $privacyText }} <a href="{{ $termsLink }}" class="terms-link">Términos y Condiciones</a> 
                        </span> 
                    </label> 
                </div> 
                <!-- Submit Button --> 
        ...
        <div class="map-wrapper" id="containerMap"> 
...
.theme-dark .checkbox-container input[type="checkbox"]:checked + .checkmark { 
    background-color: #fbbf24; 
    border-color: #fbbf24; 
} 

.theme-dark .checkbox-container input[type="checkbox"]:checked + .checkmark::after { 
    border: solid #142743; 
} 

.theme-dark .terms-link { 
    color: #fbbf24; 
} 

.theme-dark .terms-link:hover { 
    color: #f59e0b; 
} 
...
.theme-dark .submit-btn.loading::after { 
...
.theme-light .contact-subtitle { 
    ...
    margin: 0; 
    line-height: 1.1; 
    background: linear-gradient(45deg, #142743 0%, #142743 100%); 
    -webkit-background-clip: text; 
    -webkit-text-fill-color: transparent; 
    background-clip: text; 
} 
...
.theme-light .checkbox-container input[type="checkbox"]:checked + .checkmark { 
    background-color: #142743; 
    border-color: #142743; 
} 

.theme-light .checkbox-container input[type="checkbox"]:checked + .checkmark::after { 
    border: solid #ffffff; 
} 

.theme-light .terms-link { 
    color: #142743; 
} 

.theme-light .terms-link:hover { 
    color: #142743; 
} 
...
.theme-light .submit-btn.loading::after { 
...
.form-input:focus, .form-textarea:focus, .submit-btn:focus{ 
    outline-offset: 2px; 
} 

.theme-dark .form-input:focus, 
.theme-dark .form-textarea:focus, 
.theme-dark .submit-btn:focus{ 
    outline: 2px solid #fbbf24; 
} 

.theme-light .form-input:focus, 
.theme-light .form-textarea:focus, 
.theme-light .submit-btn:focus{ 
    outline: 2px solid #142743; 
} 

@media (prefers-reduced-motion: reduce) { 
    .contact-form-wrapper, .map-wrapper, .form-input, .form-textarea, .submit-btn, .checkmark { 
        animation: none; 
        transition: none; 
    } 
    .contact-form-wrapper, .map-wrapper { 
