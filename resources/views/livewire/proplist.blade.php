                    ...
                    <div class="carousel-inner" style="max-height: 150px;">
                      ...
                      @if($mobile==true)
                          ...
                          <div class="carousel-item @if($iiListing==0) active @endif">
                            <img loading="lazy" src="{{url('uploads/listing/thumb/600',$firstImg[0]??'')}}" class="d-block w-100" alt="{{$listing->listing_title}}-{{$iiListing++}}">
                        ...
                        @endphp
                          @foreach(array_filter(explode("|", $listing->images)) as $img)
                            <div class="carousel-item @if($iiListing==0) active @endif">
                              ...
                              @endphp --}}
                              <img loading="lazy" src="@if($imageVerification) {{url('uploads/listing/thumb/600',$img)}} @else {{url('uploads/listing/600',$img)}} @endif" class="d-block w-100" alt="{{$listing->listing_title}}-{{$iiListing++}}">
