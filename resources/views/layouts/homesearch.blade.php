      ...
      <div class="col-12 text-white text-center p-4" style="width: 600px;background:rgba(2, 2, 2, 0.5)">
        ...
        <div id="formtopsearch">
          ...
          <div class="input-group d-flex mb-3">
                ...
                <input type="text" placeholder="INGRESE / UBICACIÓN / CÓDIGO" id="ftop_txt" name="searchtxt" class="form-control">
                <button type="button" class="btn btn-danger" onclick="search();">BUSCAR</button>
        </div>
      </div>
        <div class="d-flex justify-content-center">
