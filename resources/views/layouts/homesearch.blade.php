<div id="parentBuscador" class="w-100" style="margin-top: 80px;">
    <div class="row align-items-center d-flex justify-content-center" style="margin: 0;">
        <div class="col-12 text-white text-center p-5" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <p class="heading-title mb-3" style="font-size: 24px; margin-bottom: 10px; font-family: 'Sharp grotesk'; font-weight:500;">Explora Nuestras Propiedades</p>
                ...
                <form id="searchForm" method="GET">
                    ...
                    <div class="mb-3 w-100 d-flex flex-column flex-md-row">
                        <div class="col-md-3 p-0">
                            <select name="ptype" id="ftop_ptype" class="form-control form-select rounded-select-search-mobile mb-2 mb-md-0" style="box-shadow: 2px 2px 5px rgba(0,0,0,0.3);">
                        ...
                        <div class="col-md-9 p-0 d-flex filters-block">
                            <input type="text" placeholder="INGRESE / UBICACIÓN / CÓDIGO" id="searchtxt" name="searchtxt" class="form-control rounded-0 rounded-input-search-mobile" style="border-radius: 0; box-shadow: 2px 2px 5px rgba(0,0,0,0.3);">
