          ...
          <div class="mb-3 w-100">
            <div class="d-flex">
              ...
              <div class="d-flex w-75">
                ...
                <button type="button" class="btn rounded-end font-weight-bold text-white" onclick="search();" style="border-radius: 0px 5px 5px 0px; background-color: #8d97b2;">BUSCAR</button>
              </div>
            </div>
        </div>
      </div>
