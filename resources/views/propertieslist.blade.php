                    ...
                    <article class="col-12 my-1 property-item" style="padding-left: 0px !important; padding-right: 0px !important;">
                        <div class="card mb-3 rounded-0">
                            <div class="row g-0 d-flex">
                                    ...
                                    <a href="/propiedad/${property.slug}" style="text-decoration: none;">
                                        <div id="carouselFeatured" class="carousel slide position-relative" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                @foreach (explode('|', $featured_property->images) as $image)
                                                    <div class="carousel-item @if($loop->index == 0) active @endif">
                                                        <img @if($loop->index > 0) loading="lazy" @endif src="{{ asset('uploads/listing/thumb/600/'.$image) }}" class="d-block w-100" alt="Imagen {{ $loop->index + 1}} de {{ $featured_property->listing_title}}">
                                                    </div>
                                                @endforeach
                                            </div>
                                ...
                                <div class="col-md-8 px-5 py-3 padding-mobile-0 position-relative" style="background-color: #182741; color: #ffffff">
                                    <div class="position-absolute" style="font-family: 'Sharp Grotesk', sans-serif;top: 0px; right: 0px; background-color: #ffffff; color: #182741; border-radius: 0px 0px 0px 25px !important;">
                                        <p class="m-0 py-3 px-3 h5">Cod: {{ $featured_property->product_code }}</p>
                                    </div>
                                    <div class="card-body">
                                        <h2 class="h5 text-white order-2" style="font-family: 'Sharp Grotesk', sans-serif; font-weight: 300;"><i class="fas fa-map-marker-alt"></i> {{ $featured_property->address ?? '' }} {{ $featured_property->city ?? '' }} {{ $featured_property->state ?? '' }}</h2>
                                        <a href="/propiedad/{{ $featured_property->slug}}" class="text-white order-1" style="text-decoration: none;">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-8 d-flex justify-content-around">
                                                @if($featured_property->bedroom > 0)
                                                    <div class="d-flex align-items-center justify-content-center w-100 border-end characteristics">
                                                        ...
                                                        <p class="pt-3" style="font-weight: 600; font-size: 15px">{{ $featured_property->bedroom ?? '' }} Hab.</p>
                                                    </div>
                                                @endif
                                                @if($featured_property->bathroom > 0)
                                                    <div class="d-flex align-items-center justify-content-center w-100 border-end characteristics">
                                                        <img width="50px" height="50px" src="{{ asset('img/banio.png') }}" alt="">
                                                        <p class="pt-3" style="font-weight: 600; font-size: 15px">{{ $featured_property->bathroom }} {{ $featured_property->bathroom > 1 ? 'Baños' : 'Baño' }}</p>
                                                    </div>
                                                @endif
                                                @if($featured_property->garage > 0)
                                                    <div class="d-flex align-items-center justify-content-center w-100 border-end characteristics">
                                                        <img width="50px" height="50px" src="{{ asset('img/estacionamiento.png') }}" alt="">
                                                        <p class="pt-3" style="font-weight: 600; font-size: 15px">{{ $featured_property->garage . $featured_property->garage > 1 ? 'Garajes' : 'Garaje' }}</p>
                                                    </div>
                                                @endif
                                                @if($featured_property->land_area > 0)
                                                    <div class="d-flex align-items-center justify-content-center w-100 characteristics">
                                                        ...
                                                        <p class="pt-3" style="font-weight: 600; font-size: 15px">{{ $featured_property->land_area }} m<sup>2</sup></p>
                                                    </div>
                                                @endif
                                            </div>
