...
@section('content')
                        ...
                        <form action="{{ route('web.sendlead') }}" method="POST" id="formDetailProp">
                            ...
                            <div class="d-flex gap-3 ms-4">
                                ...
                                <a style="text-decoration: none"
                                    href="tel:{{ $listing->listingtypestatus == 'en-venta' ? '+593964034035' : '+593964034035' }}"
                                    class="mt-1 ml-2 text-dark">{{ $listing->listingtypestatus == 'en-venta' ? '096-403-4035' : '096-403-4035' }}</a>
                            </div>
    ...
    <section class="w-100 py-3 px-3 section-interest" style="position: fixed; bottom: 0px; background-color: #242B40; z-index: 10000">
        ...
        <div class="d-flex justify-content-center align-items-center mt-1" style="gap: 10px">
            ...
            <div class="w-100">
                <a class="btn btn-outline-light rounded-pill w-100" href="tel:+593964034035">Llamar</a>
            </div>
        </div>
    </section>
