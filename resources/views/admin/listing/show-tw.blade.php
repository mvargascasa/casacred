...
@php
  ...
  $departments=0;
    ...
    foreach($allheadingdeatils as $singleedetails){ 
      ...
      if($i%2==0){  
        if($singleedetails[$i-1]==41 || $singleedetails[$i-1]==86 || $singleedetails[$i-1]==49 || $singleedetails[$i-1]==115 || $singleedetails[$i-1]==62 || $singleedetails[$i-1]==113) $bedroom+=$singleedetails[$i];
        if($singleedetails[$i-1]==48 || $singleedetails[$i-1]==76 || $singleedetails[$i-1]==81 || $singleedetails[$i-1]==49 || $singleedetails[$i-1]==113) $bathroom+=$singleedetails[$i];
