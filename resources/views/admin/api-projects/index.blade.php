...
@section('content')
    <section class="overflow-y-auto pb-10">
        <section class="container mx-auto">
            ...
            <p class="mb-4">Esta visualizando los proyectos de <span class="font-semibold">casapromotora.com</span>.  Para poder editarlos ingrese al <a class="font-semibold" style="color: blue" href="https://casapromotora.com/login" target="_blank">sitio web</a> como administrador </p>
            <section class="grid grid-cols-4 gap-4">
                @foreach ($projects as $project)
                <a href="{{ route('admin.api.project.show', $project['category_id']) }}">
                    <div class="div">
